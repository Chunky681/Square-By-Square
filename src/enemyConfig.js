...
export const ENEMY_CONFIG = {
  ...
  boss_bottom_left: { enabled: true, startDifficulty: 10 },
...
const SPAWN_WEIGHT_PROFILES = [
  ...
  // D8-D10
  { maxDifficulty: Number.POSITIVE_INFINITY, weights: { chaser: 12, dart: 10, berserker: 13, brute: 12, tank: 12, leaper: 10, splitter: 10, siphon: 9, phantom: 8, mini_boss: 2, mini_boss_miner: 2, mega_cannon_boss: 1, siphon_overlord: 1, boss_bottom_left: 1 } },
];
